...
export function RoutesPage() {
    ...
    if (assignmentPending)
        return <><PageHeading eyebrow="Your commute" title="Route & stops" description="Your route will appear here after admin assignment."/><AssignmentPendingState /></>;
    return <div><PageHeading eyebrow="Your commute" title="Route & stops" description="The complete morning schedule for your assigned route." action={<Link className="button button--secondary desktop-action" to="/student/track"><Navigation /> View live map</Link>}/>
