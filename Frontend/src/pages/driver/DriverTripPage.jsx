...
import { driverGpsDisplay, driverGuidanceStops, gpsSharingLabel } from '../../operations/gpsPresentation';
...
export function DriverTripPage() {
    ...
    const dialogRef = useDialogFocus(confirmingEnd, () => { if (!ending) setConfirmingEnd(false); });
    ...
    const guidanceStops = driverGuidanceStops(stops, nextStop.id);
    ...
    <p className="driver-gps-freshness"><Radio aria-hidden="true" /> Last GPS update: {gps.lastAccepted}</p>
