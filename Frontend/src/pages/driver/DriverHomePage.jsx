...
export function DriverHomePage() {
    ...
    const gpsNeedsAttention = active && gpsSharingStatus !== "sharing";
    if (tripLoadError) {
        return <div><StaffPageHeading eyebrow={currentDisplayDate()} title={`${currentGreeting()}, ${firstName}`} description="We could not load your assigned bus and route yet." status={<span className="staff-status staff-status--not-started">Route check needed</span>}/>
