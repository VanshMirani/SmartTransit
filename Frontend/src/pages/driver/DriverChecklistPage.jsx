...
export function DriverChecklistPage() {
    ...
    const start = () => { setStarting(true); window.setTimeout(() => { startTrip(); navigate('/driver/trip'); }, 650); };
